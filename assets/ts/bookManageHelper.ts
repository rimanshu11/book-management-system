...
import { BookStore, formData } from './bookStore.ts';
...
export class BookManagerHelper {
  ...
  constructor(bookStore: BookStore, showTable: ShowTable) {
  ...
  public calculateBookAge(publicationDate: string): string {
    ...
    if (currentDate < pubDate) {
      Utils.toggleError(
        ...
        'Future dates are not permissible. Please choose a valid date',
      );
      return '';
    }
