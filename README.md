...
7. **Sort by Author and Title**
   - Users can now sort the displayed books by **Author and Title**.
...
- Install Live Server Extension (if you're using VSCode):
...
- Right-click on the index.html file in VSCode and select Open with Live Server. This will start the server and open the project in your default browser.

### 5. Compile TypeScript
Make sure to compile your TypeScript files to JavaScript. You can do this by running:
...
- Open the browser and visit http://127.0.0.1:5500/ or http://127.0.0.1:8080/ (depending on your server's configuration).
- Make sure that all the JavaScript files are loading correctly. You can inspect the Network Tab in your browser's developer tools (F12) to verify that all resources (like config.js, fetchBook.js, etc.) are being correctly loaded.
